...
use backend\modules\userManagement\components\UserAuthEvent;
use backend\modules\userManagement\models\forms\ChangeOwnPasswordForm;
use backend\modules\userManagement\models\forms\ConfirmEmailForm;
use backend\modules\userManagement\models\forms\LoginForm;
use backend\modules\userManagement\models\forms\PasswordRecoveryForm;
...
class AuthController extends BaseController
{
	...
	public function actionLogin()
	{
		...
		{
			$defaultUrl='booking-management/booking/';
			$url=Yii::$app->getUrlManager()->createUrl($defaultUrl);
