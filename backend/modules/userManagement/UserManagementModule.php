...
namespace backend\modules\userManagement;
...
class UserManagementModule extends \webvimark\modules\UserManagement\UserManagementModule
{
     ...
     * @var string
     */
    public $registrationFormClass = 'backend\modules\UserManagement\models\forms\RegistrationForm';
    ...
    public $controllerNamespace = 'backend\modules\userManagement\controllers';
