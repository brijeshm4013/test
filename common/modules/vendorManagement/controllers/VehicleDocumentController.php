...
use Yii;
use common\models\VehicleDocument;
use common\modules\vendorManagement\models\VehicleDocument as VehicleDocumentSearch;
...
class VehicleDocumentController extends Controller
{
    ...
    {
        $searchModel = new VehicleDocumentSearch();
    ...
    /**
     * Updates an existing VehicleDocument model.
