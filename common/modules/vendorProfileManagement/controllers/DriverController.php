...
use common\modules\vendorManagement\models\VendorDriver;
...
class DriverController extends Controller
{
    ...
    protected function findModel($id)
    {
        ...
        if(User::hasRole('vendor',false)){
            ...
            $query->andWhere(['vendorDrivers.driver_id'=>$id]);
            $model=$query->one();
        }
                    ...
                    if($user->save()){
                        ...
                        if($model->save()){
                            ...
                            if(User::hasRole('vendor',false)){
                                ...
                                $vendorDriver=new VendorDriver();
                                $vendorDriver->driver_id=$model->id;
                                $vendorDriver->vendor_id=$vendor->id;
                                $vendorDriver->save();
                            }
                        }
