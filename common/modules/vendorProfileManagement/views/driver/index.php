...
<div class="driver-index">
        ...
        [
            ...
            'value'=>function($model){
                return \backend\modules\userManagement\components\GhostHtml::a(
                    ...
                    ['/document-management/driver-document/index', 'DriverDocument[driver_id]'=>$model->id],
                    ['class'=>'btn btn-sm btn-primary', 'data-pjax'=>0]);
            },

            'format'=>'raw',
            'visible'=>\backend\modules\userManagement\models\User::canRoute('/document-management/driver-document/index'),
            'options'=>[
                'width'=>'10px',
            ],
        ],
    ...
    $gridPanel=[
        'before'=>\backend\modules\userManagement\components\GhostHtml::a(
            ...
            ['/vendor-profile-management/driver/create'],
