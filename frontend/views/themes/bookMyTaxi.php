...
<head>
    ...
    <?php $this->head(); ?>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $this->theme->baseUrl ?>/font/font-awesome/css/font-awesome.min.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo $this->theme->baseUrl ?>/css/materialize.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo $this->theme->baseUrl ?>/css/prism.css" />
</head>
